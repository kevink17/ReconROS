...
entity rt_imp_rt_imp_Pipeline_VITIS_LOOP_176_12 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of rt_imp_rt_imp_Pipeline_VITIS_LOOP_176_12 is 
...
begin
    ...
    p_addr_8_out_ap_vld_assign_proc : process(ap_CS_fsm_state1, hwt_signal_read_read_fu_46_p2, p_vld_fu_73_p1, ap_start_int)
    begin
        if ((((ap_start_int = ap_const_logic_1) and (p_vld_fu_73_p1 = ap_const_lv1_0) and (hwt_signal_read_read_fu_46_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_start_int = ap_const_logic_1) and (p_vld_fu_73_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
            p_addr_8_out_ap_vld <= ap_const_logic_1;
        else 
            p_addr_8_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
