...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_NUM_INTERRUPTS" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_NUM_INTERRUPTS { PARAM_VALUE.C_NUM_INTERRUPTS } {
	# Procedure called to update C_NUM_INTERRUPTS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_NUM_INTERRUPTS { PARAM_VALUE.C_NUM_INTERRUPTS } {
	# Procedure called to validate C_NUM_INTERRUPTS
	return true
}
...
proc update_MODELPARAM_VALUE.C_NUM_INTERRUPTS { MODELPARAM_VALUE.C_NUM_INTERRUPTS PARAM_VALUE.C_NUM_INTERRUPTS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_NUM_INTERRUPTS}] ${MODELPARAM_VALUE.C_NUM_INTERRUPTS}
}
